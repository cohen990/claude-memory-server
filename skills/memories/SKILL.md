---
name: memories
description: View the graph memories that were injected into this conversation and how they were reflected on.
user-invocable: true
---

Show the user what graph memories were injected in this session and how you reflected on them.
...
- Each memory with its type (vibe/detail), similarity score, and reflection with label:
...
- If a memory is unreflected, note that
